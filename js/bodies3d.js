...
import { toRender } from './scene.js?v=32';
import { ANDROMEDA } from './data.js?v=32';
import {
...
export class SystemView {
  constructor(scene, sim) {
    ...
    // near-zero ambient: ships/stations get the same brutal sun/shadow
    // contrast as the planet shaders (their emissives still glow at night)
    scene.add(new THREE.AmbientLight(0x32404f, 0.05));
