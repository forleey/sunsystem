...
import { G0 } from './data.js?v=86';
import {
  buildSpacedock, buildRingStation, buildGateway, buildISS,
  buildFreighter, buildWarship, buildScout,
} from './fleet_meshes.js?v=86';
import { loadInto, whitewashObject } from './models.js?v=86';
import { applyGreebleShading } from './greeble.js?v=86';
import { buildGreebleStation } from './megastation.js?v=86';
