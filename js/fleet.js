...
import { toRender } from './scene.js?v=65';
import { G0 } from './data.js?v=65';
import {
  buildSpacedock, buildRingStation, buildGateway, buildISS,
  buildFreighter, buildWarship, buildScout,
} from './fleet_meshes.js?v=65';
import { loadInto, whitewashObject } from './models.js?v=65';
import { applyGreebleShading } from './greeble.js?v=65';
import { buildGreebleStation } from './megastation.js?v=65';
...
export class Fleet {
  constructor(scene, sim) {
    ...
    // K-7: textured city-disc built from depth/displacement + emissive/normal
    // maps (own textures) — opts out of the white paint scheme
