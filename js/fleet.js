...
import { G0 } from './data.js?v=79';
import {
  buildSpacedock, buildRingStation, buildGateway, buildISS,
  buildFreighter, buildWarship, buildScout,
} from './fleet_meshes.js?v=79';
import { loadInto, whitewashObject } from './models.js?v=79';
import { applyGreebleShading } from './greeble.js?v=79';
import { buildGreebleStation } from './megastation.js?v=79';
